									...
									{showManualForm ? (
										...
										<>
											<div className="flex items-center gap-2 mb-4 justify-between">
												...
												{!showManualForm && (
													<Button variant="default" onClick={() => setShowManualForm(true)}>
														Add Manual Entry
													</Button>
												)}
												{showManualForm && (
											...
											<AttendanceTable attendanceData={attendanceData} monthOptions={monthOptions} monthYear={monthYear} onMonthChange={setMonthYear} loading={false} error={null} />
										</>
									)}
								</TabsContent>

								<TabsContent value="leave">
									<EmployeeLeaveManagement branchId={branchId.id} employeeId={empId} />
								</TabsContent>
							</Tabs>
						</CardContent>
					</Card>
