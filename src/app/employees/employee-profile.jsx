...
const EmployeeProfile = () => {
	...
	const fetchEmployeeTransactions = useCallback(() => {
		if (branchId?.id && empId) {
			dispatch(fetchTransactions({ branchId: branchId.id, employeeId: empId }));
		}
						...
						<Card className="w-full md:w-1/3">
							<CardHeader className="flex flex-col items-center">
								<Avatar className="w-24 h-24 mb-4">
									<AvatarImage
										src={employee.personal?.gender == "male" ? maleTeacher : ""}
										alt={employee.personal?.gender == "female" ? femaleTeacher : ""}
									/>
