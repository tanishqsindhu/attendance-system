...
export default function PayrollDashboard() {
	...
	const handleFileUpload = async (e) => {
		...
		if (!uploadedFile || !branchId) return;
	...
	return (
		<div className="p-6">
			<div className="mb-4 p-4">
				...
				<input type="input" onChange={branchIdHanlder} className="mb-2" />
				<button onClick={() => setProcessResult({})}>Clear Data</button>
			</div>
			{processResult ? (
				<p>
					{processResult.noOfProcessDate} data has been processed done from {processResult.earliestDate}
					to {processResult.endDate}
				</p>
			) : (
				""
			)}
